      ...
      <Slide delay={0.16}>
        <div className="flex flex-col gap-y-6 mt-8 max-w-3xl">
          {education.map((edu) => (
            <div
              key={edu.id}
              className="flex items-start gap-x-4 dark:bg-primary-bg bg-secondary-bg border dark:border-zinc-800 border-zinc-200 rounded-xl p-5 sm:p-6 hover:dark:border-zinc-700 hover:border-zinc-300 duration-300"
            >
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-x-3 flex-wrap gap-y-1 mb-1">
                  <h3 className="font-incognito font-semibold text-base sm:text-lg leading-snug">
                    {edu.degree}
                  </h3>
                ...
                <p className="dark:text-zinc-400 text-zinc-500 text-sm">{edu.institution}</p>
