      ...
      <section className="relative grid lg:grid-cols-custom grid-cols-1 gap-x-10 justify-items-center">
        ...
        <div className="order-2 lg:order-none">
          <Slide>
            ...
            <div className="dark:text-zinc-400 text-zinc-600 leading-relaxed space-y-5 text-[15px]">
              <p>
        ...
        <aside className="flex flex-col lg:justify-self-center justify-self-start gap-y-8 lg:order-1 order-none mb-12">
          <Slide delay={0.1}>
            <div className="sticky top-10 flex flex-col gap-y-4 w-full lg:w-[300px]">
              ...
              {/* Profile photo */}
              <div className="rounded-2xl overflow-hidden dark:bg-primary-bg bg-secondary-bg border dark:border-zinc-800 border-zinc-200 w-[300px] h-[360px] relative">
                 <Image
                   src="/profile.png"
                   width={300}
                   height={360}
